...
public class ProdutoService {
    ...
    public Produto buscarPorId(Long coProduto) {
        return repository.findById(coProduto)
                .orElseThrow(() -> new RuntimeException("Produto não encontrado: " + coProduto));
    }

    @Transactional
    public List<Produto> listarProdutosPorIds(List<Long> coProdutos) {
        return repository.findAllById(coProdutos);
    }
